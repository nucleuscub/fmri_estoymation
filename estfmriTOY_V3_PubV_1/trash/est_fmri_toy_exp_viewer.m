function varargout = est_fmri_toy_exp_viewer(varargin)
% EST_FMRI_TOY_EXP_VIEWER MATLAB code for est_fmri_toy_exp_viewer.fig
%      EST_FMRI_TOY_EXP_VIEWER, by itself, creates a new EST_FMRI_TOY_EXP_VIEWER or raises the existing
%      singleton*.
%
%      H = EST_FMRI_TOY_EXP_VIEWER returns the handle to a new EST_FMRI_TOY_EXP_VIEWER or the handle to
%      the existing singleton*.
%
%      EST_FMRI_TOY_EXP_VIEWER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EST_FMRI_TOY_EXP_VIEWER.M with the given input arguments.
%
%      EST_FMRI_TOY_EXP_VIEWER('Property','Value',...) creates a new EST_FMRI_TOY_EXP_VIEWER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before est_fmri_toy_exp_viewer_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to est_fmri_toy_exp_viewer_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help est_fmri_toy_exp_viewer

% Last Modified by GUIDE v2.5 08-Apr-2014 23:37:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @est_fmri_toy_exp_viewer_OpeningFcn, ...
                   'gui_OutputFcn',  @est_fmri_toy_exp_viewer_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before est_fmri_toy_exp_viewer is made visible.
function est_fmri_toy_exp_viewer_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to est_fmri_toy_exp_viewer (see VARARGIN)

% Choose default command line output for est_fmri_toy_exp_viewer
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes est_fmri_toy_exp_viewer wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = est_fmri_toy_exp_viewer_OutputFcn(hObject, eventdata, handles) 
