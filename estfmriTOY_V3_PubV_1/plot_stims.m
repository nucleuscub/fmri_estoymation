function plot_stims(handles,all)
...
f = figure('Name', 'Stimulus','Position',scrsz);             % Creating fig
hold on;
...
%     stimulus_i = importdata(deblank(handles.timings(index_selected(i),:)));
%     stimulus_i = stimulus_i(1:num_runs,:);
